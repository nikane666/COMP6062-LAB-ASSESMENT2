...
const app = Vue.createApp({
    ...
    data() {
        return {
            studentName: 'Niken Bajracharya',
            pressure: 50,
            indicatorLevels: [
                { id: 'danger-low', status: 'danger', label: 'Danger - Low!', min: 0, max: 10 },
                { id: 'warning-low', status: 'warning', label: 'Warning - Low', min: 11, max: 30 },
                { id: 'safe', status: 'safe', label: 'Safe', min: 31, max: 70 },
                { id: 'warning-high', status: 'warning', label: 'Warning - High', min: 71, max: 90 },
